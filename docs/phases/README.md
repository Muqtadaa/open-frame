...
| [2 · Core canvas](phase-2-core-canvas.md)               | The canvas a person would actually use                           | ▶ Next      |
| [3 · Structured objects](phase-3-structured-objects.md) | The reason OpenFrame exists                                      | Planned     |
