...
| Decision                           | Why deferred                                                                                                                                                | Resolved by                                                                                                       |
| ---------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| **First-class relationship model** | `evidence.linkedInsightIds: ObjectId[]` in `data` works until reverse lookups are needed. An edge model is a large change to document, migrations and merge | First feature needing _"which insights cite this evidence?"_ — [Phase 3](../phases/phase-3-structured-objects.md) |
