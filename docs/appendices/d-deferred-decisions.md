...
| **Database**                                        | Narrowed to Neon on its free tier, and NOT for the document — a room's Durable Object holds that. Supabase was rejected on one line: a free project pauses after 7 days idle, and boards are returned to days later. Not signed up for; nothing needs it before Stage 3 | Phase 4 Stage 3 |
